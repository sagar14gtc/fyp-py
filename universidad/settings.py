...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure--2ro-jb-+8qi*&(^ht@w+y!8f#aqt7v0nzpyi11$_b21)(k_*s')
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.unread_counts', # Add our custom context processor
            ],
        },
    },
]
...
LOGIN_REDIRECT_URL = 'dashboard:dashboard' # Use namespaced URL name
LOGOUT_REDIRECT_URL = 'core:home' # Use namespaced URL name
